                        ...
                        <div id="sale-products" class="collapse show">
                            <div class="widget-featured-products mb_36">
                                <div class="featured-product-item">
                                    <a href="#" class="card-product-wrapper">
                                        <img class="lazyload img-product"
                                            data-src="assets/frontend/images/products/img-feature-1.png"
                                            alt="image-feature">
                                    </a>
                                ...
                                <div class="featured-product-item">
                                    <a href="#" class="card-product-wrapper">
                                        <img class="lazyload img-product"
                                            data-src="assets/frontend/images/products/img-feature-2.png"
                                            alt="image-feature">
                                    </a>
                                    <div class="card-product-info">
                                ...
                                <div class="featured-product-item">
                                    <a href="#" class="card-product-wrapper">
                                        <img class="lazyload img-product"
                                            data-src="assets/frontend/images/products/img-feature-3.png"
                                            alt="image-feature">
                                    </a>
                                    <div class="card-product-info">
                        ...
                        <div id="gallery" class="collapse show">
                            <div class="grid-3 gap-4 mb_36">
                                <a href="#" class="item-gallery">
                                    <img class="lazyload" data-src="assets/frontend/images/shop/gallery/gallery-1.jpg"
                                        alt="img-gallery">
                                </a>
                                <a href="#" class="item-gallery">
                                    <img class="lazyload" data-src="assets/frontend/images/shop/gallery/gallery-2.jpg"
                                        alt="img-gallery">
                                </a>
                                <a href="#" class="item-gallery">
                                ...
                                <a href="#" class="item-gallery">
                                    <img class="lazyload" data-src="assets/frontend/images/shop/gallery/gallery-4.jpg"
                                        alt="img-gallery">
                                </a>
                                <a href="#" class="item-gallery">
