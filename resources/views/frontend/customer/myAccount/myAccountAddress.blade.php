                            ...
                            <form class="show-form-address wd-form-address" id="formnewAddress" action="#">
                                ...
                                <div class="box-field grid-2-lg">
                                    <div class="tf-field style-1">
                                        <input class="tf-field-input tf-input" placeholder=" " type="text" id="firstname"
                                            name="first name">
                                ...
                                <div class="box-field">
                                    <div class="tf-field style-1">
                                        <input class="tf-field-input tf-input" placeholder=" " type="text" id="company"
                                            name="company">
                                ...
                                <div class="box-field">
                                    <div class="tf-field style-1">
                                        ...
                                        <label class="tf-field-label fw-4 text_black-2" for="AddressZipNew">Postal/ZIP
                                            code</label>
                                    </div>
                                </div>
                                <div class="box-field">
                                    ...
                                    <form class="edit-form-address wd-form-address" id="formeditAddress" action="#">
                                        ...
                                        <div class="box-field grid-2-lg">
                                            <div class="tf-field style-1">
                                                ...
                                                <label class="tf-field-label fw-4 text_black-2" for="firstnameEdit">First
                                                    name</label>
                                            </div>
                                            <div class="tf-field style-1">
                                                <input class="tf-field-input tf-input" placeholder=" " type="text"
                                                    id="lastnameEdit" name="last name">
                                                <label class="tf-field-label fw-4 text_black-2" for="lastnameEdit">Last
                                                    name</label>
                                            </div>
                                        </div>
                                        <div class="box-field">
                                        ...
                                        <div class="box-field">
                                            <label for="countryEdit"
                                                class="mb_10 fw-4 text-start d-block text_black-2">Country/Region</label>
                                            <div class="select-custom">
                                                <select class="tf-select w-100" id="countryEdit" name="address[country]"
                                                    data-default="">
                                                    <option value="---" data-provinces="[]">---</option>
                                                    <option value="Australia"
                                                        data-provinces="[['Australian Capital Territory','Australian Capital Territory'],['New South Wales','New South Wales'],['Northern Territory','Northern Territory'],['Queensland','Queensland'],['South Australia','South Australia'],['Tasmania','Tasmania'],['Victoria','Victoria'],['Western Australia','Western Australia']]">
                                        ...
                                        <div class="box-field text-start">
                                            <div class="box-checkbox fieldset-radio d-flex align-items-center gap-8">
                                                ...
                                                <label for="check-edit-address" class="text_black-2 fw-4">Set as default
                                                    address</a>.</label>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-center gap-20">
                                    ...
                                    <form class="edit-form-address wd-form-address" id="formeditAddress" action="#">
                                        ...
                                        <div class="box-field text-start">
                                            <div class="box-checkbox fieldset-radio d-flex align-items-center gap-8">
                                                ...
                                                <label for="check-edit-address1" class="text_black-2 fw-4">Set as default
                                                    address</a>.</label>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-center gap-20">
