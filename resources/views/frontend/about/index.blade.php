        ...
        <div class="container">
            <div class="tf-grid-layout md-col-2 tf-img-with-text style-4">
                <div class="tf-image-wrap">
                    <img class="lazyload w-100" data-src="assets/frontend/images/collections/collection-69.jpg"
                        src="assets/frontend/images/collections/collection-69.jpg" alt="collection-img">
                </div>
            ...
            <div class="tf-grid-layout md-col-2 tf-img-with-text style-4">
                ...
                <div class="grid-img-group">
                    <div class="tf-image-wrap box-img item-1">
                        <div class="img-style">
                            <img class="lazyload" src="assets/frontend/images/collections/collection-71.jpg"
                                data-src="assets/frontend/images/collections/collection-71.jpg" alt="img-slider">
                        </div>
                    </div>
                    <div class="tf-image-wrap box-img item-2">
                        <div class="img-style">
                            <img class="lazyload" src="assets/frontend/images/collections/collection-70.jpg"
                                data-src="assets/frontend/images/collections/collection-70.jpg" alt="img-slider">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flat-title lg">
                    ...
                    <div>
                        <p class="sub-title text_black-2">Our talented stylists have put together outfits that are perfect
                            for the season.</p>
                        <p class="sub-title text_black-2">They've variety of ways to inspire your next fashion-forward look.
                        </p>
                    </div>
                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="tf-icon-box text-center">
                                        ...
                                        <div class="content">
                                            ...
                                            <p class="text_black-2">Crafted with precision and excellence, our activewear is
                                                meticulously engineered using premium materials to ensure unmatched comfort
                                                and durability.</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testimonial-item lg lg-2">
                                    ...
                                    <div class="icon">
                                        <img class="lazyload" data-src="assets/frontend/images/item/quote.svg"
                                            alt="" src="assets/frontend/images/item/quote.svg">
                                    </div>
                                    <div class="rating">
                                        <i class="icon-star"></i>
                                        <i class="icon-star"></i>
                                    ...
                                    <div class="author box-author">
                                        <div class="box-img d-md-none rounded-0">
                                            <img class="lazyload img-product"
                                                data-src="assets/frontend/images/item/tets3.jpg"
                                                src="assets/frontend/images/item/tets3.jpg" alt="image-product">
                                        </div>
                                        <div class="content">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item lg lg-2">
                                    ...
                                    <div class="author box-author">
                                        <div class="box-img d-md-none rounded-0">
                                            <img class="lazyload img-product"
                                                data-src="assets/frontend/images/item/tets4.jpg"
                                                src="assets/frontend/images/item/tets4.jpg" alt="image-product">
                                        </div>
                                        <div class="content">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="img-sw-thumb">
                                    <img class="lazyload img-product" data-src="assets/frontend/images/item/tets3.jpg"
                                        src="assets/frontend/images/item/tets3.jpg" alt="image-product">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="img-sw-thumb">
                                    <img class="lazyload img-product" data-src="assets/frontend/images/item/tets4.jpg"
                                        src="assets/frontend/images/item/tets4.jpg" alt="image-product">
                                </div>
                            </div>
                        </div>
