    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-fluid">
            <div class="row g-5 g-xl-8">
                <div class="col-xl-3">
                    ...
                    <a href="{{ route('categories.index') }}" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">{{ $categoryCount ?? 0 }}</div>
                ...
                <div class="col-xl-3">
                    <!--begin::Statistics Widget 5-->
                    <a href="{{ route('brands.index') }}" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">{{ $brandCount ?? 0 }}</div>
                            <div class="fw-bold text-gray-100">Total Brand</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3">
                    <!--begin::Statistics Widget 5-->
                    <a href="{{ route('products.index') }}" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                        <!--begin::Body-->
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{ $productCount ?? 0 }}</div>
                            <div class="fw-bold text-white">Total Product</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
                ...
                <div class="col-xl-3">
                    ...
                    <a href="{{ route('customers.index') }}" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <!--end::Svg Icon-->
                            <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{ $customerCount ?? 0 }}</div>
                            <div class="fw-bold text-white">Total Customer</div>
                        </div>
                        <!--end::Body-->
                    </a>
                    <!--end::Statistics Widget 5-->
